...
// The extension's own composer dependencies (aws/aws-sdk-php etc.) are normally
// loaded when ses.php runs as part of a full module boot; at --level=classloader
// that never executes, so pull it in explicitly for the test process.
