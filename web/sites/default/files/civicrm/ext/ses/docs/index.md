...
View/Download this extension in the [Extension Directory](https://civicrm.org/extensions/amazon-simple-email-service-ses).

The extension is licensed under [AGPL-3.0](https://lab.civicrm.org/extensions/ses/-/blob/main/LICENSE.txt).
...
See [detailed configuration steps here](configuration.md).
