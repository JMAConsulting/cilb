...
(function (_) {
  CRM.$(function($) {
    ...
    function previewDialog() {
      var payload = $form.serialize() + '{/literal}&entity_table={$entityTable}&entity_id={$currentEntityId}&reset=1{literal}';
      CRM.confirm({
        width: '50%',
        url: CRM.url("civicrm/admin/advancedevents/recurringentity/preview", payload)
