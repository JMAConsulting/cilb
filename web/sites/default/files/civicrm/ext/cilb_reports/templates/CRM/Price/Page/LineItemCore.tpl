{*
  NOTE: this file should always match CRM/Price/Page/LineItem.tpl from the target core
  version. This limits the scope of our override in our custom LineItem.tpl
 *}
