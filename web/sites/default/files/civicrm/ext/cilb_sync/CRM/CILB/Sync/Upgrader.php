 ...
 */
class CRM_CILB_Sync_Upgrader extends \CRM_Extension_Upgrader_Base {
  ...
  public function upgrade_1000(): bool {
    $this->ctx->log->info('Applying update 1000 Add in Custom Entity table to handle mapping between advanced imports and exams for paper based exams');
    E::schema()->createEntityTable('upgrade/schema/1000_PaperExamImportMap_entity.php');
    return TRUE;
  }
