...
function hook_skinr_elements(&$variables, $hook, $op) {
  $elements = [];
  if ($hook == 'block') {
    $elements['block'] = [$variables['block']->module . '__' . $variables['block']->delta];
  }
  return $elements;
}
...
function hook_skinr_api_VERSION() {
  return [
    'path' => \Drupal::service('extension.path.resolver')->getPath('module', 'mymodule'),
    'directory' => 'skins',
  ];
}
...
function hook_skinr_skin_info() {
  $skins['skinr_menus'] = [
    ...
    'type' => 'select',
    'group' => 'skinr_menus',
    'theme hooks' => ['block__menu', 'block__menu_block'],
    'attached' => [
      'css' => ['css/nav.css'],
    ],
    'options' => [
      ...
      'menu_a' => [
        ...
        'class' => ['nav', 'nav-a'],
        'attached' => ['css' => ['css/nav-colors.css']],
      ],
      'menu_b' => [
  ...
  $skins['skinr_custom'] = [
    ...
    'group' => 'general',
    'theme hooks' => ['block__system', 'comment_wrapper__page', 'node__page'],
    'options' => [
      'custom' => [
        'class' => ['custom'],
      ],
...
function hook_skinr_group_PLUGIN_info() {
  $groups['extension_example_menus'] = [
    'title' => t('Menus'),
    'description' => t('Menu and navigation styles.'),
  ];
  return $groups;
