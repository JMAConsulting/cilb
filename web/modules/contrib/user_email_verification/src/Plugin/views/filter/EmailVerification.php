...
namespace Drupal\user_email_verification\Plugin\views\filter;
 ...
 *
 * @ViewsFilter("user_email_verification_verified")
 */
class EmailVerification extends FilterPluginBase {
  ...
  protected function valueValidate($form, FormStateInterface $form_state) {
    if (
      $form_state->getValue(['options', 'value']) == 'All' &&
